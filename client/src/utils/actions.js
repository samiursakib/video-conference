...
export const startPrivateCall = async (peer, conferenceId, selfVideoRef, setIsAnswered, remoteVideoRef, setCall) => {
    try {
...
export const endGroupCall = (calls, peerCalls, setCallOthersTriggered, setPeersOnConference) => {
