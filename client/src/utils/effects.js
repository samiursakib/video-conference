...
export const useSocketEventListener = (socket, peer, setPeersOnConference, setAvailableUsers, setAvailableRooms, setConferenceId, setCallOthersTriggered, setTransited, setIsAnswered, selfVideoRef, remoteVideoRef, setPeerCall, setPeerCalls) => {
  useEffect(() => {
...
export const useCallOthers = (peer, callOthersTriggered, setGroupCall, setIsAnswered, peersOnConference, setPeersOnConference, setCalls) => {
  useEffect(() => {
